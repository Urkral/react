...
const FormSimple = () => {
  ...
  }, [search]); // dans les crochets on précisera les valeurs a observer
  ...
  return (
    <form
      className="w-1/2 p-8 m-8 max-auto mx-auto bg-gray-100 shadow"
      ...
      <p className="pt-2 test-sm text-red-500">
